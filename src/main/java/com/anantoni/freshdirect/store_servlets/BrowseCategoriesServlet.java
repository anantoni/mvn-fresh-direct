 ...
 * @author anantoni
 */
@WebServlet(name = "BrowseCategoriesServlet", urlPatterns = {"/BrowseCategoriesServlet"})
public class BrowseCategoriesServlet extends HttpServlet {
            ...
            throws ServletException, IOException
    {
        ...
        if (request.getParameter("product_category") == null) {
            ...
            try {
                char product_category = request.getParameter("product_category").charAt(0);
                DatabaseManager dbManager = new DatabaseManager();
                List<Product> productList = dbManager.getProductsByCategory(product_category);
                ...
                Logger.getLogger(BrowseCategoriesServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
